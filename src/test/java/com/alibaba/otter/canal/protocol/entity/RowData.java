...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              beforeColumns_ = new java.util.ArrayList<com.alibaba.otter.canal.protocol.entity.Column>();
              mutable_bitField0_ |= 0x00000001;
            }
            beforeColumns_.add(
                input.readMessage(com.alibaba.otter.canal.protocol.entity.Column.parser(), extensionRegistry));
            break;
          }
          case 18: {
            if (!((mutable_bitField0_ & 0x00000002) != 0)) {
              afterColumns_ = new java.util.ArrayList<com.alibaba.otter.canal.protocol.entity.Column>();
          ...
          case 26: {
            if (!((mutable_bitField0_ & 0x00000004) != 0)) {
              pros_ = new java.util.ArrayList<com.alibaba.otter.canal.protocol.entity.Pair>();
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return com.alibaba.otter.canal.protocol.entity.MessageOuterClass.internal_static_com_alibaba_otter_canal_protocol_RowData_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return com.alibaba.otter.canal.protocol.entity.MessageOuterClass.internal_static_com_alibaba_otter_canal_protocol_RowData_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            com.alibaba.otter.canal.protocol.entity.RowData.class, com.alibaba.otter.canal.protocol.entity.RowData.Builder.class);
  }

  public static final int BEFORECOLUMNS_FIELD_NUMBER = 1;
  private java.util.List<com.alibaba.otter.canal.protocol.entity.Column> beforeColumns_;
  /**
   * <pre>
   **字段信息，增量数据(修改前，删除前)*
   * </pre>
   ...
   */
  @java.lang.Override
  public java.util.List<com.alibaba.otter.canal.protocol.entity.Column> getBeforeColumnsList() {
   ...
   */
  @java.lang.Override
  public java.util.List<? extends com.alibaba.otter.canal.protocol.entity.ColumnOrBuilder> 
   ...
   */
  @java.lang.Override
  public com.alibaba.otter.canal.protocol.entity.Column getBeforeColumns(int index) {
   ...
   */
  @java.lang.Override
  public com.alibaba.otter.canal.protocol.entity.ColumnOrBuilder getBeforeColumnsOrBuilder(
      int index) {
    return beforeColumns_.get(index);
  }

  public static final int AFTERCOLUMNS_FIELD_NUMBER = 2;
  private java.util.List<com.alibaba.otter.canal.protocol.entity.Column> afterColumns_;
  /**
   * <pre>
   **字段信息，增量数据(修改后，新增后)*
   * </pre>
   ...
   */
  @java.lang.Override
  public java.util.List<com.alibaba.otter.canal.protocol.entity.Column> getAfterColumnsList() {
   ...
   */
  @java.lang.Override
  public com.alibaba.otter.canal.protocol.entity.Column getAfterColumns(int index) {
   ...
   */
  @java.lang.Override
  public com.alibaba.otter.canal.protocol.entity.ColumnOrBuilder getAfterColumnsOrBuilder(
      int index) {
    return afterColumns_.get(index);
  }

  public static final int PROS_FIELD_NUMBER = 3;
  private java.util.List<com.alibaba.otter.canal.protocol.entity.Pair> pros_;
  /**
   * <pre>
   **预留拓展 *
   * </pre>
   ...
   */
  @java.lang.Override
  public java.util.List<com.alibaba.otter.canal.protocol.entity.Pair> getProsList() {
    return pros_;
  }
  /**
   * <pre>
   ...
   */
  @java.lang.Override
  public com.alibaba.otter.canal.protocol.entity.Pair getPros(int index) {
   ...
   */
  @java.lang.Override
  public com.alibaba.otter.canal.protocol.entity.PairOrBuilder getProsOrBuilder(
      int index) {
    return pros_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof com.alibaba.otter.canal.protocol.entity.RowData)) {
      return super.equals(obj);
    }
    com.alibaba.otter.canal.protocol.entity.RowData other = (com.alibaba.otter.canal.protocol.entity.RowData) obj;
  ...
  public static com.alibaba.otter.canal.protocol.entity.RowData parseFrom(
  ...
  public static com.alibaba.otter.canal.protocol.entity.RowData parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static com.alibaba.otter.canal.protocol.entity.RowData parseFrom(
  ...
  public static com.alibaba.otter.canal.protocol.entity.RowData parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static com.alibaba.otter.canal.protocol.entity.RowData parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static com.alibaba.otter.canal.protocol.entity.RowData parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(com.alibaba.otter.canal.protocol.entity.RowData prototype) {
  ...
  public static final class Builder extends
      ...
      com.alibaba.otter.canal.protocol.entity.RowDataOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.alibaba.otter.canal.protocol.entity.MessageOuterClass.internal_static_com_alibaba_otter_canal_protocol_RowData_descriptor;
    }
    ...
    // Construct using com.alibaba.otter.canal.protocol.entity.RowData.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public com.alibaba.otter.canal.protocol.entity.RowData getDefaultInstanceForType() {
      return com.alibaba.otter.canal.protocol.entity.RowData.getDefaultInstance();
    }

    @java.lang.Override
    public com.alibaba.otter.canal.protocol.entity.RowData build() {
      com.alibaba.otter.canal.protocol.entity.RowData result = buildPartial();
    ...
    @java.lang.Override
    public com.alibaba.otter.canal.protocol.entity.RowData buildPartial() {
      com.alibaba.otter.canal.protocol.entity.RowData result = new com.alibaba.otter.canal.protocol.entity.RowData(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof com.alibaba.otter.canal.protocol.entity.RowData) {
        return mergeFrom((com.alibaba.otter.canal.protocol.entity.RowData)other);
      } else {
    ...
    public Builder mergeFrom(com.alibaba.otter.canal.protocol.entity.RowData other) {
      if (other == com.alibaba.otter.canal.protocol.entity.RowData.getDefaultInstance()) return this;
      if (beforeColumnsBuilder_ == null) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      com.alibaba.otter.canal.protocol.entity.RowData parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (com.alibaba.otter.canal.protocol.entity.RowData) e.getUnfinishedMessage();
    ...
    private void ensureBeforeColumnsIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        beforeColumns_ = new java.util.ArrayList<com.alibaba.otter.canal.protocol.entity.Column>(beforeColumns_);
        bitField0_ |= 0x00000001;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.alibaba.otter.canal.protocol.entity.Column, com.alibaba.otter.canal.protocol.entity.Column.Builder, com.alibaba.otter.canal.protocol.entity.ColumnOrBuilder> beforeColumnsBuilder_;
    ...
    public Builder setBeforeColumns(
        int index, com.alibaba.otter.canal.protocol.entity.Column value) {
      if (beforeColumnsBuilder_ == null) {
        if (value == null) {
     ...
     */
    public Builder setBeforeColumns(
        int index, com.alibaba.otter.canal.protocol.entity.Column.Builder builderForValue) {
      if (beforeColumnsBuilder_ == null) {
        ensureBeforeColumnsIsMutable();
     ...
     * <code>repeated .com.alibaba.otter.canal.protocol.Column beforeColumns = 1;</code>
     */
    public Builder addBeforeColumns(com.alibaba.otter.canal.protocol.entity.Column value) {
      if (beforeColumnsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addBeforeColumns(
        com.alibaba.otter.canal.protocol.entity.Column.Builder builderForValue) {
      if (beforeColumnsBuilder_ == null) {
        ensureBeforeColumnsIsMutable();
    ...
    public Builder addAllBeforeColumns(
        java.lang.Iterable<? extends com.alibaba.otter.canal.protocol.entity.Column> values) {
      if (beforeColumnsBuilder_ == null) {
        ensureBeforeColumnsIsMutable();
     ...
     * <code>repeated .com.alibaba.otter.canal.protocol.Column beforeColumns = 1;</code>
     */
    public com.alibaba.otter.canal.protocol.entity.Column.Builder getBeforeColumnsBuilder(
        int index) {
     ...
     * <code>repeated .com.alibaba.otter.canal.protocol.Column beforeColumns = 1;</code>
     */
    public com.alibaba.otter.canal.protocol.entity.Column.Builder addBeforeColumnsBuilder() {
      return getBeforeColumnsFieldBuilder().addBuilder(
          com.alibaba.otter.canal.protocol.entity.Column.getDefaultInstance());
    }
    /**
     * <pre>
     **字段信息，增量数据(修改前，删除前)*
    ...
    public com.alibaba.otter.canal.protocol.entity.Column.Builder addBeforeColumnsBuilder(
        int index) {
      return getBeforeColumnsFieldBuilder().addBuilder(
          index, com.alibaba.otter.canal.protocol.entity.Column.getDefaultInstance());
    }
    /**
     * <pre>
     **字段信息，增量数据(修改前，删除前)*
     ...
     * <code>repeated .com.alibaba.otter.canal.protocol.Column beforeColumns = 1;</code>
     */
    public java.util.List<com.alibaba.otter.canal.protocol.entity.Column.Builder> 
         getBeforeColumnsBuilderList() {
      return getBeforeColumnsFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.alibaba.otter.canal.protocol.entity.Column, com.alibaba.otter.canal.protocol.entity.Column.Builder, com.alibaba.otter.canal.protocol.entity.ColumnOrBuilder> 
        getBeforeColumnsFieldBuilder() {
      if (beforeColumnsBuilder_ == null) {
    ...
    private void ensureAfterColumnsIsMutable() {
      if (!((bitField0_ & 0x00000002) != 0)) {
        afterColumns_ = new java.util.ArrayList<com.alibaba.otter.canal.protocol.entity.Column>(afterColumns_);
        bitField0_ |= 0x00000002;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.alibaba.otter.canal.protocol.entity.Column, com.alibaba.otter.canal.protocol.entity.Column.Builder, com.alibaba.otter.canal.protocol.entity.ColumnOrBuilder> afterColumnsBuilder_;
     ...
     * <code>repeated .com.alibaba.otter.canal.protocol.Column afterColumns = 2;</code>
     */
    public Builder addAfterColumns(com.alibaba.otter.canal.protocol.entity.Column value) {
      if (afterColumnsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     * <code>repeated .com.alibaba.otter.canal.protocol.Column afterColumns = 2;</code>
     */
    public com.alibaba.otter.canal.protocol.entity.Column.Builder getAfterColumnsBuilder(
        int index) {
     ...
     * <code>repeated .com.alibaba.otter.canal.protocol.Column afterColumns = 2;</code>
     */
    public com.alibaba.otter.canal.protocol.entity.Column.Builder addAfterColumnsBuilder() {
    ...
    private void ensureProsIsMutable() {
      if (!((bitField0_ & 0x00000004) != 0)) {
        pros_ = new java.util.ArrayList<com.alibaba.otter.canal.protocol.entity.Pair>(pros_);
        bitField0_ |= 0x00000004;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.alibaba.otter.canal.protocol.entity.Pair, com.alibaba.otter.canal.protocol.entity.Pair.Builder, com.alibaba.otter.canal.protocol.entity.PairOrBuilder> prosBuilder_;
     ...
     * <code>repeated .com.alibaba.otter.canal.protocol.Pair pros = 3;</code>
     */
    public Builder addPros(com.alibaba.otter.canal.protocol.entity.Pair value) {
      if (prosBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     * <code>repeated .com.alibaba.otter.canal.protocol.Pair pros = 3;</code>
     */
    public com.alibaba.otter.canal.protocol.entity.Pair.Builder getProsBuilder(
        int index) {
     ...
     * <code>repeated .com.alibaba.otter.canal.protocol.Pair pros = 3;</code>
     */
    public com.alibaba.otter.canal.protocol.entity.Pair.Builder addProsBuilder() {
  ...
  private static final com.alibaba.otter.canal.protocol.entity.RowData DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new com.alibaba.otter.canal.protocol.entity.RowData();
  }

  public static com.alibaba.otter.canal.protocol.entity.RowData getDefaultInstance() {
