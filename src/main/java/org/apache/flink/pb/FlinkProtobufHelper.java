...
public class FlinkProtobufHelper {
  ...
  public static RowData validateRow(RowData row, RowType rowType){
    ...
    DataStream<RowData> rows = env.fromCollection(
        Collections.singletonList(row), new RowDataTypeInfo(rowType));
